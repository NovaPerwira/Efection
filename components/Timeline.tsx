  ...
  return (
    <div className="relative flex-shrink-0 w-[400px] h-[500px] flex flex-col justify-center items-center group">
      ...
      <motion.div
        ...
        className={`
          absolute left-0 right-0 p-8 backdrop-blur-md rounded-2xl
      ...
      >
        ...
        <h3 className={`text-3xl font-serif mb-3 transition-colors duration-500 ${isActive ? 'text-[#F4E04D]' : 'text-white'}`}>
          {event.title}
        </h3>
